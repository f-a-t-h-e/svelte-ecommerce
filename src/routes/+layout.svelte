...
<div class="bg-c-1-h p-[5rem]">
	<div class="sh mx-auto w-fit max-w-[78.75rem] bg-c-1-j">
		<header class="mx-auto flex max-w-[78.75rem] flex-col items-center bg-c-1-j px-[2.8125rem]">
			<div
				class="flex min-h-[3rem] w-full py-[1rem] justify-between"
			>
				...
				<div class="[&>a]:caption inline-flex items-center gap-[2.0625rem] [&>a]:text-c-2-a">
					<a href="/">Blog</a>
					<a href="/">About Us</a>
					<a href="/">Careers</a>
				</div>
			</div>
			<hr class="h-[1px] bg-c-1-a opacity-5 w-full border-none">

			<div class="flex py-[2.5rem] w-full justify-between">
				<!-- logo -->
		...
		<div class="bg-c-1-h px-[2.8125rem]">
