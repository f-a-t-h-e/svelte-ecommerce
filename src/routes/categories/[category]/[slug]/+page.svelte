...
<main class="w-[78.75rem]">
	<div class="flex w-full gap-[2rem] px-[2.8125rem] py-[1rem]">
		...
		<div class="flex w-full flex-col gap-[3.875rem]">
			...
			<div class="desc-rev-que">
				...
				<section data-for="select-description-sec" class="flex flex-col gap-[2rem]">
					<!-- heading -->
					<div class="px-[1px]">
						<p class="s5 mb-[.5rem] text-c-1-a">Origins</p>
						<p class="body text-c-1-a">
	...
	<section class="flex w-full flex-col gap-[2rem] px-[2.8125rem] py-[4rem]">
		<HeadingWBtn
